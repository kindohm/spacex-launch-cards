    ...
    render() {
            ...
            return <div className="col s6" key={payload.payload_id}>
                <div className="card orange darken-4 white-text">
                    <div className="card-content">
                        <span className="card-title orange-text text-lighten-3">Payload {count}</span>
                        <ul>
        ...
        return <div className="row z-depth-3" style={{ paddingBottom: '20px', backgroundColor: '#fff' }}>
            <div className="col s1">
                <a style={buttonStyle} className="btn-floating btn-large orange darken-2" onClick={this.props.previousIndex}>
            ...
            <div className="col s7">
                ...
                <div className="col s12">
                    <h3 className="orange-text text-darken-2">Flight #{launch.flight_number}</h3>
            ...
            <div className="col s1 right-align">
                <a style={buttonStyle} className="btn-floating btn-large orange darken-2" onClick={this.props.nextIndex}>
